...
const SECTIONS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'grad_certificate', label: 'Graduation mark sheets (all semesters) and Degree Certificate',                               required: false, maxSizeMB: 10, multi: false },
      ...
      { key: 'pg_certificate',   label: 'Post-Graduation mark sheets (all semesters) and Degree Certificate (if applicable)',           required: false, maxSizeMB: 10, multi: false },
